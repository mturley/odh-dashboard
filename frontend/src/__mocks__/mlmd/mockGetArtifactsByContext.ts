...
// TODO grpc-mock library? look at convos with dallas?

export const mockedScalarMetricArtifact: Artifact = {
  id: 7,
  typeId: 17,
  type: 'system.Metrics',
...
const mokedRocCurveArtifact: Artifact = {
  id: 9,
  typeId: 18,
  type: 'system.ClassificationMetrics',
...
export const mockGetArtifactsByContext = (): GrpcResponse => {
  const response: GetArtifactsByContextResponse = {
    arti,
  };
